...
const QuanlyvacxinIndex = (props) => {  
  ...
  const onSubmitCreate = () => {
    ...
    if (!isValid) {
      ...
      VaccineService.create(vaccine).then(
        (response) => {
        ...
        <div className="form-input1">
         ...
         <div className="btn-vacxin1">
            ...
            <button className="update-btn1 btn-format1" type="button">
              <FaPlusCircle />
              <i className="text-btn" onClick={onSubmitCreate}>Thêm mới</i>
            </button>
          </div>
      </form>
        ...
        <Table id="customer1">
          ...
          <tbody>
            ...
            <tr key ={index}>
              <td>{index+1}</td>
              <td>{ele.code}</td>
              <td >{ele.categoryVaccineID}</td>
              <td>{ele.name}</td>
              <td>{ele.exprirationDate}</td>
              <td>{ele.producer}</td>
              <td className="description1">{ele.producer}</td>
              <td>
